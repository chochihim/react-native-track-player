...
function setAlarm(seconds) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, react_native_1.Platform.OS === 'android' ? TrackPlayer.setAlarm(seconds) : Promise.resolve()];
        });
    });
}
function cancelAlarm() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, react_native_1.Platform.OS === 'android' ? TrackPlayer.cancelAlarm() : Promise.resolve()];
        });
    });
}
// MARK: - Queue API
...
function pauseForDucking() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, react_native_1.Platform.OS === 'android' ? TrackPlayer.pauseForDucking() : TrackPlayer.pause()];
        });
    });
}
function stop() {
...
exports.default = {
    ...
    play: play,
    pause: pause,
    pauseForDucking: pauseForDucking,
    stop: stop,
    seekTo: seekTo,
    setVolume: setVolume,
    setRate: setRate,
